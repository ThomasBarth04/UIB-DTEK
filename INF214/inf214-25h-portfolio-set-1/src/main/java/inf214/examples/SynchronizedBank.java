...
/**
 * Bank example – second version.
 * 
 * This one uses Java intrinsic locks (<code>synchronized</code>).
 * 
 * @see AtomicBank
 * @see GenerousBank
 */
public class SynchronizedBank {
	...
	static class PayrollService implements Runnable {
		Account fromAccount;
		Account toAccount;
		Random random = new Random();

		public PayrollService(Account fromAccount, Account toAccount) {
